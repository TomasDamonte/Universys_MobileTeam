...
public class Error {
    ...
    public static final String SESION_DUPLICADA_TEXT = "Error: Sesion duplicada";
    ...
    public static void mostrar(String id) {
        switch (id) {
            ...
            case Error.CAMPOS_INCOMPLETOS_ERROR:
                ...
                break;
            case Error.SESION_DUPLICADA:
                Toast.makeText(CacheHelper.CONTEXT,Error.SESION_DUPLICADA_TEXT,Toast.LENGTH_SHORT).show();
            default:
